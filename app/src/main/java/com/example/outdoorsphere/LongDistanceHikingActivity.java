...
public class LongDistanceHikingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_long_distance_hiking);
        ...
        if (selectedIndex != -1 && selectedIndex < InformationMockUp.getList().size()) {
            ...
            TextView descriptionTextView = findViewById(R.id.txtinm);
            ...
            Log.e("LongDistanceHikingActivity", "Invalid index: " + selectedIndex);
