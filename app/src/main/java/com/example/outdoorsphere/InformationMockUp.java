...
public class InformationMockUp {
    ...
    public static List<Information> getListcycle() {
        ...
        list.add(new Information("Cycling","BIKE RIDES",R.drawable.bike,"Riding a bike allows you to cover greater distances in less time than you could ever achieve on foot, plus you generally need very little in the way of equipment or experience.  In many parts of the world, the increasing popularity of the bike is leading to the development of better cycling networks, which increasingly allow the rider to avoid mingling with vehicular traffic.\n" +
    ...
    public static List<Information> getList() {
        list = new ArrayList<>();
        list.add(new Information("Hiking", "Hiking Routes", R.drawable.rout, "Hikes are an assured way to discover a region's scenery, history, culture, and food. Most of the routes in this category cover well-trodden paths and trails in the countryside for which you need little more than just comfortable shoes, suitable clothing, basic provisions, and a camera for capturing the moment. ", "Assess Your Fitness Level and Hiking Experience \n"+" Research the Trail and Weather Conditions"));
        list.add(new Information("Hiking", "Long-Distance Hiking", R.drawable.longhi, "Multi-stage hikes can take many forms, from Alpine crossings to guided trips or solo adventures. These regional trails let you tackle your challenge one step at a time. ", " Training and Physical Preparation \n"+" .Route Research and Planning"));
